...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 18 17:04:26 2019
...
def plot_mca(figpath,figname,F,G=None,color=False,color_vec=None,legend=None,annotate_plt=False,labels=None,X_supp=None,s=None,labels_supp=None):        
    ...
    if color:
        if legend is not None:
            legend_entries = np.unique(legend)
            for entry in legend_entries:
                plt.scatter(row_profiles[legend == entry,0],
                            row_profiles[legend == entry,1],
                            c=color_vec[legend == entry],label=entry,marker='o')
        else:
            plt.scatter(row_profiles[:,0],
                        row_profiles[:,1],
                        c=color_vec,marker='o')
    else:
        plt.scatter(row_profiles[:,0],
